...
class PluginHytiCatHytiCat extends CommonDBTM
{
    ...
    {
        if (empty(PluginHytiCatHytiCat::$_all_categories)) {
        ...
        return PluginHytiCatHytiCat::$_all_categories;
    }
    ...
    // {
    //     $group_category = new PluginHytiCatHytiCat();
    ...
    //  * @return array
    //  */
    // public static function getUserCategories2($parent_id)
    // {
    //     $user_categories = [];
